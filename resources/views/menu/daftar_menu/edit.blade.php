            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form method="post" action="{{ route('daftar_menu.update', $menu->id) }}" id="myForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" required="required" class="form-control" name="name" id="name"
                                            aria-describedby="Name" value="{{ $menu->name }}"">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="number" required="required" class="form-control" name="price" id="price" value="{{ $menu->price }}">
                                    </div>
                                </div>
                            </div>
