                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" required="required" class="form-control" name="name" id="name" aria-describedby="name" value="{{ $promo->name }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        aria-describedby="description">{{ $promo->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="date" required="required" class="form-control" name="start_date" id="start_date"
                                            aria-describedby="start_date" value="{{ $promo->start_date }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="date" required="required" class="form-control" name="expired_date" id="expired_date"
                                            aria-describedby="expired_date" value="{{ $promo->expired_date }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8 col-lg-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" required="required" class="form-control" name="discount" id="discount"
                                            aria-describedby="discount" value="{{ $promo->discount }}">
                                    </div>
                                </div>
                            </div>
